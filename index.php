...
<body>
                ...
                <div class="col-md-9 col-sm-9">
                   ...
                   { 
                        ?> 
                           ...
                           <h3>환영합니다</h3><br>
                           <h6>내 점수 : <?php print $_SESSION['score']; ?></h6><br>
    ...
    <div class="container">
            ...
            <div class="row text-center">
                <div class="col-md-8 col-md-offset-2 ">
                    <h2><i class="fa fa-desktop fa-3x"></i>&nbsp;2016 Member </h2>
                    <h4>
                        <strong>
                                class 3 | 이지훈&nbsp;   변우진&nbsp;  김찬형&nbsp;  공규현&nbsp; 임수민&nbsp; 전윤현&nbsp; 정정환&nbsp; <br>    
                                Class 2 | 황주현&nbsp;   이민환 &nbsp; 이강민&nbsp;  정승리&nbsp; <br>
                                Class 1 | 김민석&nbsp;   김종현 &nbsp; 오경제&nbsp;  정현민 &nbsp; 한지혁&nbsp; 
                        </strong>
                    </h4>
                </div>
